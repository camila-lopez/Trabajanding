<?php
/**
 * Este archivo muestra el uso de privacidad de datos.
 *
        ...
        <div id="fornlogin" class="col-md-10 mb-3 text-center">
          ...
          <div class="col-md-8 col-sm-8 col-xs-12  slideanim text-justify" style="margin:auto;">
            ...
            <div class="row">
              ...
              <h6>5. CONTACTO</h6>
              <p>Si tiene preguntas sobre su privacidad cuando utilice el Sitio Web, por favor <a id="aqui" href="<?=base_url('trabajador/contacto')?>">CONTÁCTENOS AQUÍ</a>.</p>
